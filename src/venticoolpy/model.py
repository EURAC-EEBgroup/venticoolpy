...
class Building(object):
    ...
    shading_control_setpoint : float,  required  
    ...
    my_lighting_power_density : float, optional, default None    
    ...
    my_occupancy_gains_density : float, optional, default None
    ...
    def min_req_vent_rate(self):
        ...
        if self.my_min_req_vent_rate is not None:
            ...
            if self.my_vent_rates_mu == VENT_RATES_MU[0]: #l/s-m²
                ...
                vent_rate = self.my_min_req_vent_rate * 1000 / self.floor_area # TODO: keep this value as default?
